...
# T5(analysis/trial.py) 수동 검증 200건으로 확장·검증한 목록.
# 단독으로 대가성 공시가 성립하는 표현만 넣는다. "솔직한 후기"처럼 보상어와 붙을
# 때만 유효한 표현, 문두에서만 유효한 표현(#제품제공·할인받아 등)은 여기 넣지 말 것
# — 문맥 조건이 필요하므로 analysis/trial.py 의 규칙이 정본이다.
TRIAL_KEYWORDS = ("체험단", "체험 기회", "리뷰어 선정", "서포터즈", "협찬",
                  "앰배서더", "앰버서더",
                  "제공받아", "제공 받아", "제공받은", "제공 받은",
                  "제공받았", "제공 받았", "제공받고", "제공 받고",
                  "제공받으", "제공 받으",
                  "무상으로 제공", "무상 제공", "무상제공",
                  "무료로 제공", "무료 제공",
                  "업체로부터", "브랜드로부터", "판매자로부터",
                  "광고주", "유료 광고", "유료광고", "원고료", "대가성",
                  "소정의 지원", "소정의 원고료",
                  "제품을 지원", "제품비를 지원", "제품비의 일부를",
                  "제품비 일부를", "이벤트 상금을 지원")
